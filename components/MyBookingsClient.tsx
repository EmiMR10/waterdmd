...
export function MyBookingsClient() {
  ...
  if (error) return <main className="empty-page"><p className="eyebrow">Tu bitácora de viaje</p><h1>{error}</h1><Link className="button button--coral" href="/login">Iniciar sesión</Link></main>;
